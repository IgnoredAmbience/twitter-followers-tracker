# Code by Simon Willison from https://github.com/simonw/disaster-scrapers
    ...
    def update_message(self, old_records, new_records, verb="Updated"):
        ...
        for new_record in new_records:
            try:
                ...
                continue
            if json.dumps(old_record, sort_keys=True) != json.dumps(
                new_record, sort_keys=True
            ):
